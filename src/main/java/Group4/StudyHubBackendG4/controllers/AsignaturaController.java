...
public class AsignaturaController {
    ...
    @GetMapping("/getAsignaturasDeCarrera/{idCarrera}")
    @PreAuthorize("hasRole('ROLE_C') or hasRole('ROLE_A') or hasRole('ROLE_F') or hasRole('ROLE_E')")
    ...
    @GetMapping("/getAsignaturasDeCarreraConExamen/{idCarrera}")
    @PreAuthorize("hasRole('ROLE_C') or hasRole('ROLE_A') or hasRole('ROLE_F') or hasRole('ROLE_E')")
    ...
    @GetMapping("/getAsignaturasAprobadas/{idEstudiante}")
    ...
    @GetMapping("/getAsignaturasNoAprobadas/{idEstudiante}")
    @PreAuthorize("hasRole('ROLE_A') or hasRole('ROLE_E')")
    ...
    @PostMapping("/getHorarios/{idAsignatura}")
    @PreAuthorize("hasRole('ROLE_C') or hasRole('ROLE_A') or hasRole('ROLE_F') or hasRole('ROLE_E')")
    ...
    @PostMapping("/registroHorarios/{idAsignatura}")
    ...
    @PostMapping("/inscripcionAsignatura")
    ...
    @PostMapping("/registrarPreviaturas/{idAsignatura}")
    @PreAuthorize("hasRole('ROLE_F') or hasRole('ROLE_A')")
    ...
    @PostMapping("/cambiarResultadoCursada/{idCursada}")
